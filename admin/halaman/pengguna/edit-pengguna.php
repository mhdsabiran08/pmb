							...
							<form class="form-horizontal" action="pemroses/pengguna/edit.php?id_admin=<?php echo $data['id_admin']; ?>" method="post">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input id="name" name="password" type="password" placeholder="isi jika ingin mengubah password" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input id="name" name="password2" type="password" placeholder="konfirmasi perubahan password" class="form-control">
										</div>
									</div>

									<!-- Tombol -->
									<div class="form-group">
										<div class="col-md-4 col-md-offset-6 widget-right pull-right">
