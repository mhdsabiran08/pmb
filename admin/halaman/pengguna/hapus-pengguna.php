							...
							<form class="form-horizontal" action="pemroses/pengguna/hapus.php?id_admin=<?php echo $data['id_admin']; ?>" method="post">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" placeholder="nama lengkap" class="form-control" value="<?php echo $data['nama_lengkap']; ?>" readonly>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" placeholder="username" class="form-control" value="<?php echo $data['username']; ?>" readonly>
										</div>
									</div>
